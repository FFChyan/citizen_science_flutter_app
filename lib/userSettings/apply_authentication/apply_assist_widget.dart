...
class ApplyAssist extends StatefulWidget {
  _ApplyAssist createState() => _ApplyAssist();
}

class _ApplyAssist extends State<ApplyAssist> with TickerProviderStateMixin {
  bool _tick = false;
  TextEditingController _nameController;
  TextEditingController _institutionNameController;
  TextEditingController _positionController;
  TextEditingController _chosenController;
  FocusNode _nameFocusNode = new FocusNode();
  FocusNode _institutionNameFocusNode = new FocusNode();
  FocusNode _positionFocusNode = new FocusNode();
  FocusNode _chosenFocusNode = new FocusNode();
    ...
    return Padding(
      ...
      child: SizedBox(
        ...
        child: Column(
          children: <Widget>[
            Image(
              image: AssetImage('assets/images/assistcard.png'),
              width: 150,
            ),
//                      Text(
//                        "科学家认证",
...
//                color: new Color.fromARGB(200, 20, 10, 40),
                ...
                image: DecorationImage(
                  image: AssetImage("assets/images/ciyun4.png"),
                  fit: BoxFit.cover,
                ),
              ),
              child: Column(
        ...
        Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                  "助理认证条件助理认证条件助理认证条件助理认证条件助理认证条件助理认证条件助理认证条件助理认证条件助理认证条件助理认证条件助理认证条件助理认证条件助理认证条件助理认证条件助理认证条件助理认证条件助理认证条件",
...
//                maxLength: 20,
                cursorColor: Colors.black54,
                controller: _chosenController,
                focusNode: _chosenFocusNode,
                style: CSTextStyle.titleTextStyle.copyWith(
                    letterSpacing: 3,
                    color: Colors.black54,
                    fontWeight: FontWeight.w400),
