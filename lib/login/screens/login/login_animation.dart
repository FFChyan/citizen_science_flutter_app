...
class LoginEnterAnimation {
  LoginEnterAnimation(this.controller)
      : backgroundOpacity = new Tween(begin: 0.0, end: 1.0).animate(
        ...
        forgotPasswordOpacity = new Tween(begin: 0.0, end: 1.0).animate(
          new CurvedAnimation(
            parent: controller,
            curve: new Interval(
              0.7,
        ...
        submitBtnOpacity = new Tween(begin: 0.0, end: 1.0).animate(
          new CurvedAnimation(
            parent: controller,
            curve: new Interval(
              0.8,
  ...
  final Animation<double> forgotPasswordOpacity;
  final Animation<double> submitBtnOpacity;
