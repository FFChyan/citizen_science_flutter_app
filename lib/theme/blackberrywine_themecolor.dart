...
class ThemeColorBlackberryWine{
  ...
  static const int _darkBlue = 0xFF003366;
  static const int _blueGreen = 0xFF0099CC;
  ...
  static const MaterialColor darkBlue = const MaterialColor(
    _darkBlue,
    const <int, Color>{
      50: const Color(0xFF0f4176),
      100: const Color(0xFF0c3e72),
      200: const Color(0xFF093c6e),
      300: const Color(0xFF06396c),
      400: const Color(0xFF033669),
      500: const Color(_darkBlue), // 0x003366
      600: const Color(0xFF003063),
      700: const Color(0xFF002760),
      800: const Color(0xFF00245d),
      900: const Color(0xFF00215a),
    },
  );
